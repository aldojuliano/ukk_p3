...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(rgba(255, 0, 179, 0.8), rgba(73, 4, 21, 0.8)), url('https://images.unsplash.com/photo-1523050853064-80041f00965f?auto=format&fit=crop&w=1350&q=80');
        ...
        .navbar {
            ...
            box-shadow: 0 2px 10px rgba(15, 180, 180, 0.1);
        }
...
<body>
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; 2026 E-Pengaduan Sekolah - SMK Krian 1 Sidoarjo</p>
        </div>
    </footer>
